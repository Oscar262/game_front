...
public class OauthController {
    ...
    public static JwtOutput singn(String username, String passwordField) {
        ...
        userInput.setEmail(username);
        userInput.setPassword(passwordField);
    ...
    @FXML
    public static JwtOutput register(String username, String passwordField) {
        String apiUrl = url + "/register"; // Reemplaza con tu URL de API
        JwtOutput jwtOutput = new JwtOutput();
        UserInput userInput = new UserInput();
        userInput.setEmail(username);
        userInput.setPassword(passwordField);
